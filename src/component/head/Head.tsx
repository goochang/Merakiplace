...
export const HeadStyle = styled.div`
  ...
  `;
export const HeadMenu = styled.div<{$flag: number }>`
  max-width: 200px;
  overflow: hidden;
  border: 1px solid ${props => (props.$flag ? "#82B0F4" : "#C4C4C4")};
  border-radius: 30px;
  margin-right:12px;
  padding: 6px 12px;
  font-size: 14px;
  color: ${props => (props.$flag ? "#3478F6" : "#6D6D6D")};
  display: flex;
  align-items: center;
  cursor: pointer;
